        ...
        if(m.context === 'validateJava'){
            if(m.result == null){
                ...
                setOverlayContent(
                    ...
                    'In order to join Resist.Network, you need a 64-bit installation of Java 8. Would you like us to install a copy? By installing, you accept <a href="http://www.oracle.com/technetwork/java/javase/terms/license/index.html">Oracle\'s license agreement</a>.',
                    'Install Java',
                    'Install Manually'
                )
                setOverlayHandler(() => {
            ...
            if(login) {
                ...
                const tempListener = function(data){
                    if(GAME_LAUNCH_REGEX.test(data.trim())){
                        toggleLaunchArea(false)
                        if(hasRPC){
                            DiscordWrapper.updateDetails('Want to play a game?')
                        }
